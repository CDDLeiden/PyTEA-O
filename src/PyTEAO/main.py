...
ARGUEMENTS = {
	...
	'v': {
		'flag': 'validate',
		'help': "Run TEA-O validation process",
		'action': 'store_true',
		'default': None
	}
}
...
def main(args:argparse.Namespace|None=None) -> None:
	...
	if not args.validate and args.msa_file is None:
	...
	if args.subfamilies_file is not None:
		tree = UserTree(msa,args.subfamilies_file)
	elif args.tree_type == 'lineage':
		tree = TaxonTree(msa)
...
if __name__ == "__main__":
	...
	main(args=general.parse_args(function_args=ARGUEMENTS))